...
export const SERVICES = [
  ...
  },
  {
    ...
    formType: "generic",
    est: "By availability",
    fields: ["employeeName", "dept", "preferredDate", "location", "description"],
  },
  {
    id: "event-coverage",
    name: "Event Coverage",
  ...
  },
  {
    ...
    formType: "generic",
    est: "Same day",
    fields: ["title", "dept", "description", "audience"],
  },
  {
    id: "media-presentation",
    name: "Media / Public Presentation",
    icon: "▤",
    description: "PowerPoint, keynotes, public-facing decks",
    status: "soon",
    formType: "generic",
    est: "5–10 business days",
    fields: ["title", "dept", "description", "audience", "deadline"],
  },
  {
    id: "turtle-press",
    name: "The Turtle Press",
    icon: "🐢",
    description: "Article submissions, birthdays & celebrations, photo contributions",
    status: "live",
    formType: "generic",
    est: "Next publication cycle",
